 ...
 * @author Sean Owen
 */
public final class VCardParser extends ResultParser {
    ...
    public static AddressBookParsedResult parseData(Result result) {
        // Although we should insist on the raw text ending with "END:VCARD", there's no reason
        // to throw out everything else we parsed just because this was omitted. In fact, Eclair
        // is doing just that, and we can't parse its contacts without this leniency.
        String rawText = result.getContents();
    ...
    @Override
    public ParsedResult parse(com.google.zxing.Result theResult) {
        return null;
    }
}
