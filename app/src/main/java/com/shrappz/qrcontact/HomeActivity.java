...
public class HomeActivity extends AppCompatActivity {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
            ...
            if (hasWriteContactsPermission != PackageManager.PERMISSION_GRANTED) {
                requestPermissions(new String[]{Manifest.permission.CAMERA, Manifest.permission.READ_CONTACTS,
                        Manifest.permission.WRITE_CONTACTS,Manifest.permission.INTERNET}, REQUEST_CODE_ASK_PERMISSIONS
                );
            }
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.profile:
                startActivity(new Intent(HomeActivity.this, MyContactActivity.class));
        }
        return super.onOptionsItemSelected(item);
    }
}

//TODO Splash and Demo Screen , IF Internet :: Google Analytics and Crash Reporting -- Crashlytics
//TODO: DEEPLinks