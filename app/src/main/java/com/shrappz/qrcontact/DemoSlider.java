...
public class DemoSlider extends AppCompatActivity {
    String[] slider_headings = {"Share or scan a QR Contact at a click", "Access your contacts and create QRCodes", "Create a widget to have your personalised QR Contact","Go to widgets in your HomeScreen as shown here ","Place the QRContact Widget to get your personalised QRCONTACT"};
